...
An adaptor to use [middy middleware](https://github.com/middyjs/middy) as functional middleware. Please note that this will limit type safety.
...
```typescript
import { ieNoOpen } from '@lambda-middleware/middy-adaptor'
